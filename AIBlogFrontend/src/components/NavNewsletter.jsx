...
const NavNewsletter = () => {
  ...
  return (
    <form id="newsletter" className="bg-black mt-8 px-4 overflow-auto " onSubmit={handleSubmit(onSubmit)}>
        ...
        {isSubmitted ? (
          ...
          <div className="flex flex-col w-full">
            <input
              ...
              required
            />
            <button className="overflow-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 w-full rounded-md mb-8">
              SUBMIT
            </button>
          </div>
        )}
